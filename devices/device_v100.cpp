...
namespace {
const QString kStylesheetPath(":/main/devices/style/v100_stylesheet.css");
}

Device_V100::Device_V100(const QString &title, const QPixmap &schema, Device *parent)
    ...
    , ui(new Ui::Device_V100)
{
    ...
    ui->wCurrentMeter->setUnit("мА");
    ui->wVoltageMeter->setUnit("кВ");

    auto wCurrentGraph = new QCustomPlot(this);
    wCurrentGraph->setSizePolicy(QSizePolicy::Expanding, QSizePolicy::Expanding);
    ui->horizontalLayout_4->addWidget(wCurrentGraph);

    auto wVoltageGraph = new QCustomPlot(this);
    wVoltageGraph->setSizePolicy(QSizePolicy::Expanding, QSizePolicy::Expanding);
    ui->horizontalLayout_5->addWidget(wVoltageGraph);

    wCurrentGraph->xAxis->setRange(0, 25);
    wCurrentGraph->yAxis->setRange(0, 120);

    wVoltageGraph->xAxis->setRange(0, 25);
    wVoltageGraph->yAxis->setRange(0, 120);
...
Device_V100::~Device_V100()
{
    delete ui;
}

void Device_V100::on_ScanPortButton_clicked()
{
    ui->PortBox->clear();
...
void Device_V100::on_ModeBox_currentIndexChanged(int index)
{
    switch (index) {
    case 0:
    case 1:
...
void Device_V100::on_TimerPreSetBox_activated(int index)
{
//    switch (index) {
//    case 0:// 1min
//    {
...
void Device_V100::on_AutoVoltageSlider_valueChanged(int value)
{
    ui->AutoVoltageValue->setValue(value);
}


void Device_V100::on_AutoVoltageValue_valueChanged(int arg1)
{
    ui->AutoVoltageSlider->setValue(arg1);
}


void Device_V100::on_ReadButton_clicked()
{
...
void Device_V100::on_WriteButton_clicked()
{
...
void Device_V100::on_ProgrammSelectBox_currentIndexChanged(int index)
...
void Device_V100::on_AC1NameEdit_textChanged(const QString &arg1)
{
    //ui->ProgrammSelectBox->setItemText(0, arg1);
}


void Device_V100::on_tabWidget_currentChanged(int index)
{
    if (index == 0)
    {
...
void Device_V100::on_AC2NameEdit_textChanged(const QString &arg1)
{
    //ui->ProgrammSelectBox->setItemText(1, arg1);
}


void Device_V100::on_AC3NameEdit_textChanged(const QString &arg1)
{
    //ui->ProgrammSelectBox->setItemText(2, arg1);
}


void Device_V100::on_AC4NameEdit_textChanged(const QString &arg1)
{
    //ui->ProgrammSelectBox->setItemText(3, arg1);
}


void Device_V100::on_AC5NameEdit_textChanged(const QString &arg1)
{
   // ui->ProgrammSelectBox->setItemText(4, arg1);
}


void Device_V100::on_DC1NameEdit_textChanged(const QString &arg1)
{
    //ui->ProgrammSelectBox->setItemText(5, arg1);
}


void Device_V100::on_DC2NameEdit_textChanged(const QString &arg1)
{
    //ui->ProgrammSelectBox->setItemText(6, arg1);
}


void Device_V100::on_DC3NameEdit_textChanged(const QString &arg1)
{
    //ui->ProgrammSelectBox->setItemText(7, arg1);
}


void Device_V100::on_DC4NameEdit_textChanged(const QString &arg1)
{
    //ui->ProgrammSelectBox->setItemText(8, arg1);
}


void Device_V100::on_DC5NameEdit_textChanged(const QString &arg1)
{
...
void Device_V100::ProcessReadedData (V100Core::InputDataTypeDef data)
...
//        ui->TimerSecValue->setValue(data.time_in_seconds%60);
        ...
        ui->TimerValue->setTime(QTime(0, data.time_in_seconds/60, data.time_in_seconds%60));
...
void Device_V100::ShowDeviceInfo(QString deviceInfo) // Отпраяем требование изменить данные о установке
{
...
void Device_V100::ShowErrorInfo(QString info)// Показываем сообщение об ошибке
{
    //ui->statusbar->showMessage(info,3000);
    QMessageBox::information(this, "Ошибка", info);
}

void Device_V100::ShowStatus(QString info,int color) // Показываем состояние
{
   // QPalette palette;
...
QVector<QStringList> Device_V100::protocol()
{
    return Device::protocol();
}

void Device_V100::on_StartButton_clicked()
{
    uint8_t time_dir = 0;
    ...
    case 2: //3-АC-авто
    {
        ...
        //m_core->start(3,ui->AutoVoltageValue->value()*100,ui->AutoCurValue->value()*100,U_Speed,ui->timeEdit->time().minute(), time_dir, off_after_timer, 1);
    }break;

    case 3: //1-DC-авто
    {

        //m_core->start(1,ui->AutoVoltageValue->value()*100,ui->AutoCurValue->value()*100,U_Speed,ui->timeEdit->time().minute(), time_dir, off_after_timer, 1);
    }break;

    case 4: //4-Прожиг
    {

        //m_core->start(4,ui->AutoVoltageValue->value()*100,ui->AutoCurValue->value()*100,U_Speed,ui->timeEdit->time().minute()*100, time_dir, off_after_timer, 1);
    }break;
...
void Device_V100::on_StopButton_clicked()
{
    m_core->stop();
...
//    ui->TimerSecValue->setValue(0);
    ...
    ui->TimerValue->setTime(QTime(0, 1, 0));
}


void Device_V100::on_ManualUP_clicked()
{
    m_core->SendSteps(10);
}


void Device_V100::on_ManualDown_clicked()
{
    m_core->SendSteps(-10);
}


void Device_V100::on_ManualUP_2_clicked()
{
    m_core->SendSteps(1);
}


void Device_V100::on_ManualDown_2_clicked()
{
    m_core->SendSteps(-1);
}
